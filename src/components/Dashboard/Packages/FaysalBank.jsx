        ...
        <div className="border-slate-200 border flex flex-col gap-6 rounded-xl shadow-lg">
            <div className="flex justify-between">
                <div className="flex items-center gap-2 bg-pure pl-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray">2 Days Package</p>
                    </div>
                </div>
                <div className="bg-[#EF4444] p-2 flex flex-col justify-center items-center rounded-bl-3xl">
                    <LockedSvg />
                    <div className="text-pure">Locked</div>
                </div>
            </div>
            <div>
            ...
            <div className="flex items-center justify-between p-3">
                <div className="flex flex-col">
                    <h6 className="font-bold">1000-5000</h6>
                    <span className="text-[#16A34A]">1 Sold</span>
                </div>
